...
public class GeneratedEcdhKeyProviderFactory extends AbstractGeneratedEcKeyProviderFactory<KeyProvider> {
    ...
    public static final String ECDH_ALGORITHM_MODE_KEY = "ecdhAlgorithmMode";
    public static final String ECDH_ALGORITHM_MODE_DIRECT = "Direct key agreement mode";
    public static final String ECDH_ALGORITHM_MODE_KW = "Key wrapping mode";
