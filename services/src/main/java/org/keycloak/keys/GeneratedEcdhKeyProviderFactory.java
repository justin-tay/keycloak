...
public class GeneratedEcdhKeyProviderFactory extends AbstractGeneratedEcKeyProviderFactory<KeyProvider> {
    ...
    protected static final String ECDH_ALGORITHM_MODE_KEY = "ecdhAlgorithmMode";
    protected static final String ECDH_ALGORITHM_MODE_DIRECT = "Direct key agreement mode";
    protected static final String ECDH_ALGORITHM_MODE_KW = "Key wrapping mode";

    protected static final String ECDH_ELLIPTIC_CURVE_KEY = "ecdhEllipticCurveKey";
    protected static final String ECDH_PRIVATE_KEY_KEY = "ecdhPrivateKey";
    protected static final String ECDH_PUBLIC_KEY_KEY = "ecdhPublicKey";
    ...
    protected static ProviderConfigProperty ECDH_ALGORITHM_MODE_PROPERTY = new ProviderConfigProperty(
            ECDH_ALGORITHM_MODE_KEY, "Algorithm Mode", "Mode for processing the Content Encryption Key", LIST_TYPE,
            ECDH_ALGORITHM_MODE_DIRECT, ECDH_ALGORITHM_MODE_DIRECT, ECDH_ALGORITHM_MODE_KW);
    ...
    private static final List<ProviderConfigProperty> CONFIG_PROPERTIES = AbstractGeneratedEcKeyProviderFactory.configurationBuilder()
            ...
            .property(ECDH_ALGORITHM_MODE_PROPERTY)
            .build();
