...
public class GeneratedEcdhKeyProvider extends AbstractEcKeyProvider {
    ...
    protected KeyWrapper loadKey(RealmModel realm, ComponentModel model) {
        ...
        String ecInNistRep = model.getConfig().getFirst(GeneratedEcdhKeyProviderFactory.ECDH_ELLIPTIC_CURVE_KEY);
        String ecdhAlgorithmMode = model.getConfig().getFirst(GeneratedEcdhKeyProviderFactory.ECDH_ALGORITHM_MODE_KEY);
        ...
        try {
            ...
            String algorithm;
            if(GeneratedEcdhKeyProviderFactory.ECDH_ALGORITHM_MODE_DIRECT.equals(ecdhAlgorithmMode)) {
            	algorithm = Algorithm.ECDH_ES;
            } else {
                algorithm = GeneratedEcdhKeyProviderFactory.convertECDomainParmNistRepToJWEAlgorithm(ecInNistRep);
            }
