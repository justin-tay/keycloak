...
public class DefaultCryptoProvider implements CryptoProvider {
    ...
    public DefaultCryptoProvider() {
        ...
        providers.put(CryptoConstants.ECDH_ES, new EcdhEsAlgorithmProvider());
        providers.put(CryptoConstants.ECDH_ES_A128KW, new EcdhEsAlgorithmProvider());
        providers.put(CryptoConstants.ECDH_ES_A192KW, new EcdhEsAlgorithmProvider());
        providers.put(CryptoConstants.ECDH_ES_A256KW, new EcdhEsAlgorithmProvider());
