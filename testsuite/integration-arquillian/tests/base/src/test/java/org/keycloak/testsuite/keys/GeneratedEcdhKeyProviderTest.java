...
public class GeneratedEcdhKeyProviderTest extends AbstractKeycloakTest {
    ...
    private static final String ECDH_ALGORITHM_MODE_KEY = GeneratedEcdhKeyProviderFactory.ECDH_ALGORITHM_MODE_KEY;
    private static final String ECDH_ALGORITHM_MODE_DIRECT = GeneratedEcdhKeyProviderFactory.ECDH_ALGORITHM_MODE_DIRECT;
    private static final String ECDH_ALGORITHM_MODE_KW = GeneratedEcdhKeyProviderFactory.ECDH_ALGORITHM_MODE_KW;
