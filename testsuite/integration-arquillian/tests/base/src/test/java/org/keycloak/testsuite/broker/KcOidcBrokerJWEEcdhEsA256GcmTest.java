...
public class KcOidcBrokerJWEEcdhEsA256GcmTest extends KcOidcBrokerJWETest {

    public KcOidcBrokerJWEEcdhEsA256GcmTest() {
        super(JWEConstants.ECDH_ES, JWEConstants.A256GCM, Algorithm.ES512);
    }
