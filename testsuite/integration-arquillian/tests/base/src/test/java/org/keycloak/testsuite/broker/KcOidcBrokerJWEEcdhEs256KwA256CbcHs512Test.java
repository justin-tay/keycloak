...
public class KcOidcBrokerJWEEcdhEs256KwA256CbcHs512Test extends KcOidcBrokerJWETest {

    public KcOidcBrokerJWEEcdhEs256KwA256CbcHs512Test() {
        super(JWEConstants.ECDH_ES_A256KW, JWEConstants.A256CBC_HS512, Algorithm.ES512);
    }
    ...
    protected ComponentExportRepresentation getProviderKeyProvider() {
        ...
        config.putSingle("ecdsaEllipticCurveKey", "P-521");
    ...
    protected ComponentExportRepresentation getConsumerKeyProvider() {
        ...
        config.putSingle("ecdhEllipticCurveKey", "P-521");
        component.setConfig(config);
